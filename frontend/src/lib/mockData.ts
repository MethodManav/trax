...
const generatePriceHistory = (basePrice: number, days: number = 14): { date: string; price: number }[] => {
...
export const mockTrackers: Tracker[] = [
  ...
  },
  {
    ...
    url: 'https://lululemon.com/abc-jogger',
    currentPrice: 128,
    targetPrice: 100,
    originalPrice: 128,
  ...
  },
  {
    ...
    status: 'alert',
    priceHistory: generatePriceHistory(115),
...
export const mockAlerts: Alert[] = [
  ...
  },
  {
    ...
    trackerId: '6',
    category: 'clothing',
    message: 'Patagonia Better Sweater dropped by 29%',
    priceChange: -29,
